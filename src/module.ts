...
import type { ChunksOutdatedPayload, SkewAdapterConfig, SkewConnection, SkewSSEConfig, SkewVersionDetection, SkewWebSocketConfig } from '#skew-protection/app/types'
...
declare module '#app' {
  ...
  interface NuxtApp {
    ...
    _skewVersionDetection?: SkewVersionDetection
  }
...
`
    ...
    addComponent({
      name: 'SkewUpdateNotification',
      filePath: resolver.resolve('./runtime/app/components/SkewUpdateNotification.vue'),
    })

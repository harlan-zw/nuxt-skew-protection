...
Available adapters:
- [Pusher](/docs/skew-protection/providers/pusher)
- [Ably](/docs/skew-protection/providers/ably)
- [Reverb](/docs/skew-protection/providers/reverb) (Laravel Reverb)

Adapters use [Laravel Echo](https://laravel.com/docs/broadcasting) under the hood. Install the required dependencies:

```bash
npx nypm add laravel-echo pusher-js
```

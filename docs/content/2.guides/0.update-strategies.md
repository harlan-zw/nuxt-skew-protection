...
::callout{type="info"}
Bot traffic is automatically excluded from connections when `@nuxtjs/robots` is installed. See [Bot Traffic Filtering](/docs/skew-protection/guides/performance#bot-traffic-filtering).
::

...
a new version is deployed. To get these updates to your users you can use the built-in [`<SkewNotification>`{lang="html"}](/docs/skew-protection/api/skew-notification) component or build your own using the
...
- [`onAppOutdated()`{lang="ts"}](/docs/skew-protection/api/use-skew-protection#onappoutdated) - triggers whenever a new version is detected.

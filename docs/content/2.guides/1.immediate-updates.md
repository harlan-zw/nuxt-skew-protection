...
a new version is deployed. You can use the built-in [`<SkewNotification>`{lang="html"}](/docs/skew-protection/api/skew-notification) component or build your own using the

---
title: Nuxt Hooks
description: Respond to skew protection events with Nuxt hooks.
relatedPages:
  - path: /docs/skew-protection/nitro-api/nitro-hooks
    title: Nitro Hooks
...
Triggered for every message received from the SSE or [WebSocket](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket) connection. Use it to handle connection messages in your app.
...
Use these hooks to change settings before the connection opens.

---
title: Nitro Hooks
description: Track and respond to real-time connections with Nitro hooks.
relatedPages:
  - path: /docs/skew-protection/api/nuxt-hooks
    title: Nuxt Hooks
  - path: /docs/skew-protection/guides/live-connections
    title: View Active Connections
---

Use Nitro hooks to track connections, authorize stats access, and send messages over SSE/WebSocket connections.

...
### 🎨 Built-in and Headless UI

The module shows a native update notification by default. Add `<SkewNotification>`{lang="html"}
when you need a custom interface or Nuxt UI:
```vue
<template>

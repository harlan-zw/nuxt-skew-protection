...
The default `prompt` strategy shows a native update notification. You do not need to add a component.

Add this example to `app.vue` or a layout when you want to replace the built-in interface with Nuxt UI.
